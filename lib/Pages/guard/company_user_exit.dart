...
class CompanyUserExit extends StatefulWidget {
  const CompanyUserExit({Key? key}) : super(key: key);

  @override
  State<CompanyUserExit> createState() => _CompanyUserExitState();
}

class _CompanyUserExitState extends State<CompanyUserExit> {
