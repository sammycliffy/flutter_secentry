...
class CompanyExitInfo extends StatefulWidget {
  final CompanyVisitorModel? visitorModel;
  CompanyExitInfo({Key? key, this.visitorModel}) : super(key: key);

  @override
  _CompanyExitInfoState createState() => _CompanyExitInfoState();
}

class _CompanyExitInfoState extends State<CompanyExitInfo> {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          heightSpace(50),
                          CustomButton(
                              text: 'Exit Visitor', validate: validate),
                          heightSpace(50),
                        ],
                      ),
                    )
  ...
  validate() async {
    ...
    dynamic result = await _guardServices.exitCompanyVisitor(
